...
const char *mcp_procedure_arg_blurb (GimpProcedure *procedure, int i);
...
void mcp_set_string (GimpProcedureConfig *config, const char *name, const char *v);
 ...
 * build-configure-merge cycle happens here. Property values are supplied as
 * doubles and coerced to whatever type the operation declares.
 *
